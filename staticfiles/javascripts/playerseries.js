...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Mostra a seção de episódios por padrão e ativa o botão de episódios
    showSection('episodios');
    document.querySelector('.category-button[data-target="#episodios"]').classList.add('active');
});
